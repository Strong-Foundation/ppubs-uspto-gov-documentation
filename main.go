...
var (
	accessToken = "eyJzdWIiOiJhNGIyMjFlMy0yNzhhLTQ2YjYtYjEwNS0zNDBiNzZhZDlmOTciLCJ2ZXIiOiI3Mjg0YWU5NS0xMjUyLTQ4MGMtOGI4YS0zMGUyYzhiZmNmNTUiLCJleHAiOjB9" // API access token string
)
